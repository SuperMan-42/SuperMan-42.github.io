...
function sskadmin(e) {
    var ssk = '';
    if (e.user_id == 6357934951798670081) {
        if (checkMobile()) {
...
function ua(string){
    ...
    if (checkMobile()) {
        return '<span class="ua platform '+sua.os.name+'">'+sua.os.name+' '+sua.os.version+'</span><br><br><span class="ua browser '+sua.browser.name+'">'+sua.browser.name+' '+sua.browser.version+'</span>';
    } else {  
        return '<span class="ua platform '+sua.os.name+'">'+sua.os.name+' '+sua.os.version+'</span><span class="ua browser '+sua.browser.name+'">'+sua.browser.name+' '+sua.browser.version+'</span>';
    }
}
// function ua(e) {
//     var r = new Array;
